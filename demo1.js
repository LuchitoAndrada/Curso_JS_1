...
if (isNaN(opcion) || opcion < 1 || opcion > 3) {
    ...
    switch (opcion) {
        ...
        case 1:
            ...
            //si la variable num1 se marca como NaN en la consola o es menor o igual a 0 o la variable num2 es NaN o menor o igual a 0, entonces
        ...
        case 3: 
            ...
            if(!nombre || !/^[A-Za-zÁÉÍÓÚÜÑáéíóúüñ\s]+$/.test(nombre.trim())) {
                ...
                break;
            }else if(isNaN(edad) || edad <= 0 || edad > 99 || !Number.isInteger(edad)) { //si edad is isNaN o edad menor o igual a 0 o edad mayor a 99 o edad diferente de valor entero, entonces
